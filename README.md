...
## 📂 Projects
- **CSE Office Management System** (Java, Swing, JDBC)  
- **Speech Emotion Recognition System** (Machine Learning, CNN)  
- **Student Success Prediction System** (ML-based Thesis Project)  
